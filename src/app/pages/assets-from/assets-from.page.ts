...
export class AssetsFromPage implements OnInit {
  ...
  // public isAvailable = new BehaviorSubject(false);
  ...
  constructor() {
    this.assets = this.formServiceService.assets;
    this.fieldMapping = this.formServiceService.fieldMapping;
  }
